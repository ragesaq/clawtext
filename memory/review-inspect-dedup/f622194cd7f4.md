...
[ .] settranslationoffsets: role=right, x=-., y=-., z=-. [ .] -> openvr deviceid for right = [ .] -> preserving existing rotation: pitch=., yaw=., roll=. [ .] -> applying via sharedmemoryipc: pos(x=-.034m, y=-.008m, z=-.001m) [ .] -> success: offset applied to device [ .] settranslationoffsets: role=right, x=-., y=-., z=-. [ .] -> openvr deviceid for right = --- _suggested action:_ review this snippet for promotion; annotate priority/category/suggested action if ok.

## Examples

- 2026-03-04-hmd-cutoff.md:391 applying matched:["SUCCESS: Offset applied to device"]
...
[2026-03-04 01:17:35.308] -> SUCCESS: Offset applied to dev

- 2026-03-04-hmd-cutoff.md:396 applying matched:["SUCCESS: Offset applied to device"]
...
[2026-03-04 01:17:35.343] -> SUCCESS: Offset applied to dev
