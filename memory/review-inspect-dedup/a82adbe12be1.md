...
[ .] -> applying via sharedmemoryipc: pos(x=-.036m, y=-.002m, z=-.001m) [ .] -> success: offset applied to device [ .] settranslationoffsets: role=right, x=-., y=-., z=-. [ .] -> openvr deviceid for right = [ .] -> preserving existing rotation: pitch=., yaw=-., roll=. [ .] -> applying via sharedmemoryipc: pos(x=-.036m, y=-.002m, z=-.001m) [ .] -> success: offset applied to device --- _suggested action:_ review this snippet for promotion; annotate priority/category/suggested action if ok.

## Examples

- 2026-03-04-hmd-cutoff.md:2452 right matched:["SUCCESS: Offset applied to device"]
...
[2026-03-04 01:31:22.926] -> Preserving existing rotation: pitch=2.046, yaw=-1.523, roll=

- 2026-03-04-hmd-cutoff.md:2457 right matched:["SUCCESS: Offset applied to device"]
...
[2026-03-04 01:31:23.553] -> Preserving existing rotation: pitch=2.046, yaw=-1.523, roll=

- 2026-03-04-hmd-cutoff.md:2462 right matched:["SUCCESS: Offset applied to device"]
...
[2026-03-04 01:31:23.585] -> Preserving existing rotation: pitch=2.046, yaw=-1.523, roll=
