...
. [info] [smoothing] >>> applying to device (controller): enabled=true, strength=., filtertype= (adaptive one euro) . [info] [smoothing] ✓ success - config written to shared memory for device . [info] [smoothing] configuration applied to active devices . [debug] [events] mousebuttonrelease accepted=true isaccepted=true . [debug] [events] mousebuttondown at (,) button=left timestamp= . [debug] [events] mousebuttonpress accepted=true isaccepted=false . [debug] [events] mousebuttonup at (,) button=left timestamp= --- _suggested action:_ review this snippet for promotion; annotate priority/category/suggested action if ok.

## Examples

- 2026-03-04-hmd-cutoff.md:5461 isaccepted matched:["\\[DEBUG\\] \\[EVENTS\\] MouseButton"]
...
2026-03-04 01:14:30.168 [DEBUG] [EVENTS] MouseButtonRelease accepted

- 2026-03-04-hmd-cutoff.md:6076 isaccepted matched:["\\[DEBUG\\] \\[EVENTS\\] MouseButton"]
...
2026-03-04 01:16:02.571 [DEBUG] [EVENTS] MouseButtonRelease accepte

- 2026-03-04-hmd-cutoff.md:6087 isaccepted matched:["\\[DEBUG\\] \\[EVENTS\\] MouseButton"]
...
2026-03-04 01:16:02.776 [DEBUG] [EVENTS] MouseButtonRelease accepte
