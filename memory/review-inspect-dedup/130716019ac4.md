...
. [debug] [events] mousebuttonpress accepted=true isaccepted=false . [debug] [events] mousebuttonup at (,) button=left timestamp= . [info] [smoothing] >>> set_device_type_strength: controller . -> . deviceids=(openvr) (openvr) . [debug] [events] mousebuttonrelease accepted=true isaccepted=true . [debug] [events] mousebuttondown at (,) button=left timestamp= . [debug] [events] mousebuttonpress accepted=true isaccepted=false . [debug] [events] mousebuttonup at (,) button=left timestamp= --- _suggested action:_ review this snippet for promotion; annotate priority/category/suggested action if ok.

## Examples

- 2026-03-04-hmd-cutoff.md:4796 isaccepted matched:["\\[DEBUG\\] \\[EVENTS\\] MouseButton"]
...
2026-03-04 01:13:43.117 [DEBUG] [EVENTS] MouseButtonRelease accepted=true isAccepte

- 2026-03-04-hmd-cutoff.md:4801 isaccepted matched:["\\[DEBUG\\] \\[EVENTS\\] MouseButton"]
...
2026-03-04 01:13:43.296 [DEBUG] [EVENTS] MouseButtonRelease accepted=true isAccep

- 2026-03-04-hmd-cutoff.md:4812 isaccepted matched:["\\[DEBUG\\] \\[EVENTS\\] MouseButton"]
...
2026-03-04 01:13:43.616 [DEBUG] [EVENTS] MouseButtonRelease accepted=true isAccep
