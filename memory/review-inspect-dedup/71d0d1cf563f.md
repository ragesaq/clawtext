...
[ .] settranslationoffsets: role=right, x=-., y=-., z=-. [ .] -> openvr deviceid for right = [ .] -> preserving existing rotation: pitch=., yaw=., roll=. [ .] -> applying via sharedmemoryipc: pos(x=-.036m, y=-.007m, z=-.001m) [ .] -> success: offset applied to device [ .] settranslationoffsets: role=right, x=-., y=-., z=-. [ .] -> openvr deviceid for right = --- _suggested action:_ review this snippet for promotion; annotate priority/category/suggested action if ok.

## Examples

- 2026-03-04-hmd-cutoff.md:833 applying matched:["SUCCESS: Offset applied to device"]
...
[2026-03-04 01:21:33.064] -> SUCCESS: Offset applied to dev

- 2026-03-04-hmd-cutoff.md:838 applying matched:["SUCCESS: Offset applied to device"]
...
[2026-03-04 01:21:33.326] -> SUCCESS: Offset applied to dev
