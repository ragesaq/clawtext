...
[ .] -> preserving existing rotation: pitch=., yaw=., roll=. [ .] -> applying via sharedmemoryipc: pos(x=-.034m, y=-.006m, z=-.001m) [ .] -> success: offset applied to device [ .] settranslationoffsets: role=right, x=-., y=-., z=-. [ .] -> openvr deviceid for right = [ .] -> preserving existing rotation: pitch=., yaw=., roll=. [ .] -> applying via sharedmemoryipc: pos(x=-.034m, y=-.006m, z=-.001m) --- _suggested action:_ review this snippet for promotion; annotate priority/category/suggested action if ok.

## Examples

- 2026-03-04-hmd-cutoff.md:368 right matched:["SUCCESS: Offset applied to device"]
...
[2026-03-04 01:17:34.974] -> OpenVR deviceId for Righ

- 2026-03-04-hmd-cutoff.md:373 right matched:["SUCCESS: Offset applied to device"]
...
[2026-03-04 01:17:35.007] -> OpenVR deviceId for Righ
