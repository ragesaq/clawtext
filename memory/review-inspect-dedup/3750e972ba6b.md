...
[ .] -> preserving existing rotation: pitch=., yaw=-., roll=. [ .] -> applying via sharedmemoryipc: pos(x=-.037m, y=.000m, z=-.001m) [ .] -> success: offset applied to device [ .] settranslationoffsets: role=right, x=-., y=., z=-. [ .] -> openvr deviceid for right = [ .] -> preserving existing rotation: pitch=., yaw=-., roll=. [ .] -> applying via sharedmemoryipc: pos(x=-.037m, y=.000m, z=-.001m) --- _suggested action:_ review this snippet for promotion; annotate priority/category/suggested action if ok.

## Examples

- 2026-03-04-hmd-cutoff.md:2355 right matched:["SUCCESS: Offset applied to device"]
...
[2026-03-04 01:31:14.415] -> OpenVR deviceId for Right

- 2026-03-04-hmd-cutoff.md:2360 right matched:["SUCCESS: Offset applied to device"]
...
[2026-03-04 01:31:14.710] -> OpenVR deviceId for Right

- 2026-03-04-hmd-cutoff.md:2365 right matched:["SUCCESS: Offset applied to device"]
...
[2026-03-04 01:31:14.742] -> OpenVR deviceId for Right
