...
[ .] -> openvr deviceid for left = [ .] -> preserving existing rotation: pitch=-., yaw=-., roll=-. [ .] -> applying via sharedmemoryipc: pos(x=.010m, y=.008m, z=.034m) [ .] -> success: offset applied to device [ .] settranslationoffsets: role=left, x=-., y=., z=-. [ .] -> openvr deviceid for left = [ .] -> preserving existing rotation: pitch=-., yaw=-., roll=-. --- _suggested action:_ review this snippet for promotion; annotate priority/category/suggested action if ok.

## Examples

- 2026-03-04-hmd-cutoff.md:598 success matched:["SUCCESS: Offset applied to device"]
...
[2026-03-04 01:19:06.873] setTranslationOffsets: role=Left, x=-3.41, y=0.79, z=-0.9

- 2026-03-04-hmd-cutoff.md:603 success matched:["SUCCESS: Offset applied to device"]
...
[2026-03-04 01:19:06.906] setTranslationOffsets: role=Left, x=-3.42, y=0.79, z=-0.9

- 2026-03-04-hmd-cutoff.md:608 success matched:["SUCCESS: Offset applied to device"]
...
[2026-03-04 01:19:07.368] setTranslationOffsets: role=Left, x=-3.45, y=0.79, z=-0.9
