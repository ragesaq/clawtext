...
[ .] -> preserving existing rotation: pitch=-., yaw=-., roll=-. [ .] -> applying via sharedmemoryipc: pos(x=.010m, y=.008m, z=.031m) [ .] -> success: offset applied to device [ .] -> right: pitch=., yaw=., roll=., x=-., y=-., z=-. [ .] setrotationoffsets: role=right, pitch=., yaw=., roll=. [ .] -> openvr deviceid for right = [ .] -> preserving existing translation: x=., y=., z=. --- _suggested action:_ review this snippet for promotion; annotate priority/category/suggested action if ok.

## Examples

- 2026-03-04-hmd-cutoff.md:233 right matched:["SUCCESS: Offset applied to device"]
...
[2026-03-04 01:14:49.373] setRotationOffse
