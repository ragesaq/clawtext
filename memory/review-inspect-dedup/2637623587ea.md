...
[ .] settranslationoffsets: role=left, x=-., y=., z=-. [ .] -> openvr deviceid for left = [ .] -> preserving existing rotation: pitch=-., yaw=-., roll=-. [ .] -> applying via sharedmemoryipc: pos(x=.010m, y=.008m, z=.035m) [ .] -> success: offset applied to device [ .] settranslationoffsets: role=left, x=-., y=., z=-. [ .] -> openvr deviceid for left = --- _suggested action:_ review this snippet for promotion; annotate priority/category/suggested action if ok.

## Examples

- 2026-03-04-hmd-cutoff.md:617 applying matched:["SUCCESS: Offset applied to device"]
...
[2026-03-04 01:19:07.405] -> SUCCESS: Offset applied to device 

- 2026-03-04-hmd-cutoff.md:622 applying matched:["SUCCESS: Offset applied to device"]
...
[2026-03-04 01:19:07.437] -> SUCCESS: Offset applied to device 
