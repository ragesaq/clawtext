...
[ .] settranslationoffsets: role=left, x=-., y=., z=-. [ .] -> openvr deviceid for left = [ .] -> preserving existing rotation: pitch=-., yaw=-., roll=-. [ .] -> applying via sharedmemoryipc: pos(x=.017m, y=.012m, z=.036m) [ .] -> success: offset applied to device [ .] settranslationoffsets: role=left, x=-., y=., z=-. [ .] -> openvr deviceid for left = --- _suggested action:_ review this snippet for promotion; annotate priority/category/suggested action if ok.

## Examples

- 2026-03-04-hmd-cutoff.md:1986 applying matched:["SUCCESS: Offset applied to device"]
...
[2026-03-04 01:30:54.283] -> SUCCESS: Offset applied to device 

- 2026-03-04-hmd-cutoff.md:1991 applying matched:["SUCCESS: Offset applied to device"]
...
[2026-03-04 01:30:54.318] -> SUCCESS: Offset applied to device 

- 2026-03-04-hmd-cutoff.md:1996 applying matched:["SUCCESS: Offset applied to device"]
...
[2026-03-04 01:30:54.350] -> SUCCESS: Offset applied to device 
