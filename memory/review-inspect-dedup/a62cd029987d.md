...
. [info] [smoothing] ✓ success - config written to shared memory for device . [debug] [events] mousebuttonrelease accepted=true isaccepted=true . [debug] [events] mousebuttondown at (,) button=left timestamp= . [debug] [events] mousebuttonpress accepted=true isaccepted=false . [debug] [events] mousebuttonup at (,) button=left timestamp= . [info] [smoothing] >>> set_device_type_strength: controller . -> . deviceids=(openvr) (openvr) . [info] [smoothing] applying to openvr devices... --- _suggested action:_ review this snippet for promotion; annotate priority/category/suggested action if ok.

## Examples

- 2026-03-04-hmd-cutoff.md:5666 isaccepted matched:["\\[DEBUG\\] \\[EVENTS\\] MouseButton"]
...
- 2026-03-04-hmd-cutoff.md:5688 isaccepted matched:["\\[DEBUG\\] \\[EVENTS\\] MouseButton"]
...
- 2026-03-04-hmd-cutoff.md:5698 isaccepted matched:["\\[DEBUG\\] \\[EVENTS\\] MouseButton"]
