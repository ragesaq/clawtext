...
[ .] -> preserving existing rotation: pitch=., yaw=., roll=. [ .] -> applying via sharedmemoryipc: pos(x=-.038m, y=.009m, z=-.001m) [ .] -> success: offset applied to device [ .] settranslationoffsets: role=right, x=-., y=., z=-. [ .] -> openvr deviceid for right = [ .] -> preserving existing rotation: pitch=., yaw=., roll=. [ .] -> applying via sharedmemoryipc: pos(x=-.038m, y=.009m, z=-.001m) --- _suggested action:_ review this snippet for promotion; annotate priority/category/suggested action if ok.

## Examples

- 2026-03-04-hmd-cutoff.md:1267 right matched:["SUCCESS: Offset applied to device"]
...
[2026-03-04 01:29:09.143] -> OpenVR deviceId for Right 

- 2026-03-04-hmd-cutoff.md:1272 right matched:["SUCCESS: Offset applied to device"]
...
[2026-03-04 01:29:09.177] -> OpenVR deviceId for Right 
