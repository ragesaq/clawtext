...
[ .] -> openvr deviceid for left = [ .] -> preserving existing rotation: pitch=-., yaw=-., roll=-. [ .] -> applying via sharedmemoryipc: pos(x=.025m, y=.008m, z=.036m) [ .] -> success: offset applied to device [ .] cycleadjustmentmode: entry - current mode=translation [ .] cycleadjustmentmode: about to change mode from translation [ .] cycleadjustmentmode: state changed to rotation mode --- _suggested action:_ review this snippet for promotion; annotate priority/category/suggested action if ok.

## Examples

- 2026-03-04-hmd-cutoff.md:1520 success matched:["SUCCESS: Offset applied to device"]
